        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-4 ml-auto text-right text-muted d-flex justify-content-end">
                    <a href="?p=pg/armazenamento/adicionar.php" class="link inline"><i class="fas fa-plus"></i> Adicionar</a> &nbsp;&nbsp;&nbsp;
                    <div class="dropdown">
                        <a href="?p=pg/armazenamento/editar" class="link dropdown-toggle" id="pesquisa" data-toggle="dropdown"><i class="fas fa-search"></i> Pesquisar</a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-sem-borda" aria-labelledby="pesquisa">
                            <form action="?p=pg/armazenamento/index.php" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 style="font-weight:bold">[ Armazenamento ]</h1>
                    <br>
                </div>
            </div>
